...
-- @changelog
--   + changing the way we read notes in the editor, to update map to be more economic
--   + Converter window added.
--   + option to set how many clicks it requires to set articulations on a take. 